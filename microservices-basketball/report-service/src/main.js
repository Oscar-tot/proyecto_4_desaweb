        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    port = configService.get('PORT') || 5003;
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _a.sent();
                    console.log("\n\uD83D\uDE80 Report Service running on: http://localhost:".concat(port));
                    console.log("\uD83D\uDCDA Swagger UI available at: http://localhost:".concat(port, "/swagger"));
                    console.log("\uD83D\uDCBE Database: ".concat(configService.get('DB_DATABASE'), "\n"));
                    return [2 /*return*/];
            }
        });
    });
