...
export class LoginComponent {
  ...
  loginWithGoogle() {
    const gatewayUrl = 'http://localhost:5000/api/auth/google';
    window.location.href = gatewayUrl;
  }

  loginWithFacebook() {
    const gatewayUrl = 'http://localhost:5000/api/auth/facebook';
    window.location.href = gatewayUrl;
  }

  loginWithGithub() {
    const gatewayUrl = 'http://localhost:5000/api/auth/github';
    window.location.href = gatewayUrl;
  }
}